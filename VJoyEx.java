        ...
        try {
            ...
            GlobalScreen.addNativeKeyListener(new NativeKeyListener() {
                ...
                public void nativeKeyPressed(NativeKeyEvent e) {
                    ...
                    if (e.getKeyCode() != NativeKeyEvent.VC_W && throttleController.getAxisThrottleValue() >= 1) {
                        throttleController.setAxisThrottleValue(0);
                    }
                    if (e.getKeyCode() == NativeKeyEvent.VC_W) {

//                        throttleController.setTargetValue(50000);
//                        throttleController.smoothThrottleControl();
